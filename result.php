...
<head>
<meta charset="utf-8">
<title><?php if($row['text1']) echo "{$row['text1']}让{$row['text2']}武汉造，你呢？";else echo "琴台音乐厅请你看汉造《卡门》"; ?></title>
<meta content="width=device-width, initial-scale=1.0, minimum-scale=1.0, maximum-scale=1.0, user-scalable=no" name="viewport">
<link rel="stylesheet" href="http://fun-x.b0.upaiyun.com/kamen/css/kamen.css">
    ...
    <div class="kamen" style="display:block;">
        <div class="page page9">
            <div class="p_video video_full_screen" style="display:none;">
                <video id="video0" data-index="0" poster="img/video.jpg" x-webkit-airplay="true" webkit-playsinline="true" preload="auto" src="http://fun-x.b0.upaiyun.com/kamen/video/1.mp4" autoplay loop></video>
            </div>
        ...
        <div class="page shared">
            ...
            <img src="img/qrcode.png" class="p_element qrcode">
        </div>
    </div>
...
<script src="http://fun-x.b0.upaiyun.com/kamen/js/jquery.min.js"></script>
<script src="http://res.wx.qq.com/open/js/jweixin-1.0.0.js"></script>
<script type="text/javascript">
    document.ontouchmove = function(e){ e.preventDefault(); };
var isShare = "<?php echo isset($_GET['share']); ?>";
var istext = "<?php echo $row['text1']; ?>";
if(istext){
    var title = "<?php echo $row['text1']; ?>让<?php echo $row['text2']; ?>武汉造，你呢？"
}else{
    var title = "琴台音乐厅请你看汉造《卡门》";
}
...
wx.ready(function() {
    var options = {
        title: title,
        desc: '最美武汉 大家造',
        link: 'http://m.fun-x.cn/kamenM/result.php?token=<?php echo $row["token"]; ?>&share',
        imgUrl: 'http://m.fun-x.cn/kamenM/img/share.jpg',
        success: function() {
            if(!isShare){
                $(".go_share").hide();
                $(".share").show();
...
$(function() {
    ...
    $(".p9_btn3").click(function(){
        location.href="http://m.fun-x.cn/kamenM/";
    })
    ...
    $(".share_btn").click(function(){       
        ...
        if(tel==''){
            ...
            if(!reg.test(tel)){
                ...
                var data={mobile:tel};
                $.post("api_mobile.php",data,function(response){
